                                            ...
                                            <tbody>
                                                <c:forEach var="mascota" items="${mascotas}">
                                                    <tr>
                                                        ...
                                                        <td>${mascota.getIDUSUARIO()}</td>
                                                        <td>${mascota.getRaza()}</td>
                                                        <td>${mascota.getEspecie()}</td>
                                                        <td>${mascota.getSexo()}</td>
                                                        <td>
                                                            <a class="btn btn-warning" href="srvMascota?accion=editarMascota&id=${mascota.getIDMASCOTA()}"><i class="fa fa-pencil"></i></a>
                                                            <a class="btn btn-danger" href="srvMascota?accion=deleteMascota&id=${mascota.getIDMASCOTA()}"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="srvMascota?accion=agregar" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="menu" value="Mascotas" />
                                <div class="form-group">
                                    <label>Nombre</label>
                                ...
                                <div class="form-group">
                                    <label>Raza</label>
                                    <input type="text" name="txtRaza" value="" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Sexo</label>
                                    <input type="text" name="txtSexo" value="" class="form-control">
                                </div>

                                <div class="form-group">
                                    <label>Especie</label>
                                    <input type="text" name="txtEspecie" value="" class="form-control">
                                </div>
                                <div class="mb-3">
                                    <label>Foto:</label>
                                    <input type="file" name="fileFoto" value="" class="form-control">
                                </div>
                                <div class="text-center">
